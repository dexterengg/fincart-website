...
const MutualfundData = ({description}) => {
  ...
  return (
    <section className='pt-4'>
        <p className='text-center textForMobileOnly'>{description}</p>
         <div className= ' d-flex , justify-content-center, align-item-center cursor mutualfund_buton pt-5'>
